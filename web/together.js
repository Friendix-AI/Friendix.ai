document.addEventListener('DOMContentLoaded', () => {
    ...
    if (themeBackBtn) {
        themeBackBtn.addEventListener('click', (e) => {
            e.stopPropagation();
    ...
    const currentTheme = localStorage.getItem('friendix_theme') || 'system';
    ...
    document.addEventListener('click', (e) => {
        if (settingsDropdown && settingsDropdown.classList.contains('show') && !settingsDropdown.contains(e.target) && !railSettingsBtn.contains(e.target)) {
            settingsDropdown.classList.remove('show');
        }
        if (themeDropdown && themeDropdown.classList.contains('show') && !themeDropdown.contains(e.target)) {
            themeDropdown.classList.remove('show');
        }
    });
    ...
    function setRandomBackground() {
        const backgrounds = ["backgrounds/together1.jpg", "backgrounds/together2.jpg"];
